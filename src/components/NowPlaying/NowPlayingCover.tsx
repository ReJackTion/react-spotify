  ...
  return (
    <div
      className={cx(
        classes.wrapper,
        { 'w-14 h-14': small },
        'cursor-pointer relative pb-[100%]'
      )}
    >
      <div
        onClick={toggleMinimized}
        className="w-auto h-auto hidden z-10 bg-black absolute top-[5px] right-[5px] hover:scale-105 justify-center items-center bg-opacity-70 rounded-full"
      >
        {!small ? <ChevronDown size={24} /> : <ChevronUp size={24} />}
      </div>
      <Image
        alt="NowPlaying"
