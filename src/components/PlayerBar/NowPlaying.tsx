  ...
  return (
    <div className="flex flex-1 gap-2 items-center">
      ...
      <div className="flex flex-col text-white mr-[14px]">
        <Text
          lineClamp={1}
          className="text-sm font-semibold hover:underline cursor-pointer max-w-[260px] line-clamp-1"
        >
          {media?.title}
        </Text>
        <Text
          lineClamp={1}
          className="text-[0.6875em] font-light text-[#a7a7a7] hover:underline cursor-pointer"
        >
          {media?.interpreter}
        </Text>
      </div>
      <div className="text-[#b3b3b3] flex items-center">
        <div className="w-8 h-8 flex justify-center items-center">
          <ControlButton
            tooltipLabel="Save to Your Library"
            icon={<Heart size={20} />}
          />
        </div>
        <div className="w-8 h-8 flex justify-center items-center">
          <ControlButton
            tooltipLabel="Miniplayer"
