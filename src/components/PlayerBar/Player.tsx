...
import {
  selectPlaying,
  setPlaying,
} from '../../store/features/nowPlaying.slice'
      ...
      <div className="mb-[12px]">
        <div className="flex items-center text-[#b3b3b3] w-full gap-4">
          ...
          <div className="flex-1 flex gap-4 items-center justify-start">
            <ControlButton
              icon={<PlayerSkipForward fill="currentColor" size={20} />}
            />
            <ControlButton
              tooltipLabel="Enable repeat"
              icon={<Repeat size={20} />}
            />
          </div>
        </div>
